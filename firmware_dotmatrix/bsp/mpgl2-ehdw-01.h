...
^^^^^ Timer and PWM (audio) peripheral setup values
***********************************************************************************************************************/
...
#define PA_29_ACCEL_PWR_EN       (u32)0x20000000
...
#define PA_08_TP52               (u32)0x00000100
#define PA_07_TP51               (u32)0x00000080
#define PA_06_TP49               (u32)0x00000040
...
#define PB_13_TP16              (u32)0x00002000
#define PB_12_LCD_CS            (u32)0x00001000
#define PB_11_LCD_BL            (u32)0x00000800
#define PB_10_VSLIDE_CH2_Y      (u32)0x00000400
#define PB_09_VSLIDE_CH2_X      (u32)0x00000200
#define PB_08_VSLIDE_CH1_Y      (u32)0x00000100 
#define PB_07_VSLIDE_CH1_X      (u32)0x00000080
#define PB_06_VSLIDE_CH0_Y      (u32)0x00000040
#define PB_05_VSLIDE_CH0_X      (u32)0x00000020
#define PB_04_BLADE_AN1         (u32)0x00000010
#define PB_03_BLADE_AN0         (u32)0x00000008
#define PB_02_ACCEL_INT2        (u32)0x00000004
#define PB_01_ACCEL_INT1        (u32)0x00000002
...
/* 
    ...
    08 [1] PA_08_TP52 PIO control enabled

    07 [1] PA_07_TP51 PIO control enabled
    06 [1] PA_06_TP49 PIO control enabled
...
/*
    ...
    13 [1] PB_13_TP16 PIO control enabled
    12 [1] PB_12_LCD_CS PIO control enabled

    11 [1] PB_11_LCD_BL PIO control enabled
    10 [1] *PB_10_VSLIDE_CH2_Y PIO control enabled
    09 [1] *PB_09_VSLIDE_CH2_X PIO control enabled
    08 [1] *PB_08_VSLIDE_CH1_Y PIO control enabled

    07 [1] *PB_07_VSLIDE_CH1_X PIO control enabled
    06 [1] *PB_06_VSLIDE_CH0_Y PIO control enabled
    05 [1] *PB_05_VSLIDE_CH0_X PIO control enabled
    04 [0] PB_04_BLADE_AN1 PIO control not enabled

    03 [0] PB_03_BLADE_AN0 PIO control not enabled
    02 [1] PB_02_ACCEL_INT2 PIO control enabled
    01 [1] PB_01_ACCEL_INT1 PIO control enabled
...
/* 
    ...
    08 [0] PA_08_TP52 not controlled by peripheral

    07 [0] PA_07_TP51 not controlled by peripheral
    06 [0] PA_06_TP49 not controlled by peripheral
...
/*
    ...
    13 [0] PB_13_TP16 not controlled by peripheral
    12 [0] PB_12_LCD_CS not controlled by peripheral

    11 [0] PB_11_LCD_BL not controlled by peripheral
    10 [0] *PB_10_VSLIDE_CH2_Y not controlled by peripheral
    09 [0] *PB_09_VSLIDE_CH2_X not controlled by peripheral
    08 [0] *PB_08_VSLIDE_CH1_Y not controlled by peripheral

    07 [0] *PB_07_VSLIDE_CH1_X not controlled by peripheral
    06 [0] *PB_06_VSLIDE_CH0_Y not controlled by peripheral
    05 [0] *PB_05_VSLIDE_CH0_X not controlled by peripheral
    04 [1] PB_04_BLADE_AN1 controlled by peripheral

    03 [1] PB_03_BLADE_AN0 controlled by peripheral
    02 [0] PB_02_ACCEL_INT2 not controlled by peripheral
    01 [0] PB_01_ACCEL_INT1 not controlled by peripheral
...
*/
#define PIOA_OER_INIT (u32)0xBB55D615
/* 
    31 [1] PA_31_HEARTBEAT output enabled
    30 [0] PA_30_TP44 input
    29 [1] PA_29_ACCEL_PWR_EN output enabled
    ...
    08 [0] PA_08_TP52 input

    07 [0] PA_07_TP51 input
    06 [0] PA_06_TP49 input
...
#define PIOB_OER_INIT (u32)0x01BFDFE0
/*
    31 [0] PB_31_
    30 [0] PB_30_
    29 [0] PB_29_
    ...
    11 [1] PB_11_LCD_BL output enabled
    10 [1] *PB_10_VSLIDE_CH2_Y output enabled
    09 [1] *PB_09_VSLIDE_CH2_X output enabled
    08 [1] *PB_08_VSLIDE_CH1_Y output enabled

    07 [1] *PB_07_VSLIDE_CH1_X output enabled
    06 [1] *PB_06_VSLIDE_CH0_Y output enabled
    05 [1] *PB_05_VSLIDE_CH0_X output enabled
    04 [0] PB_04_BLADE_AN1 input

    03 [0] PB_03_BLADE_AN0 input
    02 [0] PB_02_ACCEL_INT2 input
    01 [0] PB_01_ACCEL_INT1 input
...
/* 
    ...
    29 [0] PA_29_ACCEL_PWR_EN output 
    28 [0] PA_28_BUZZER output 

    27 [0] PA_27_CLOCK_OUT output 
    26 [0] PA_26_TP30 output 
    ...
    08 [0] PA_08_TP52 output 

    07 [0] PA_07_TP51 output 
    06 [0] PA_06_TP49 output 
...
#define PIOB_ODR_INIT (u32)0x0040201F
/*
    31 [0] PB_31_
    30 [0] PB_30_
    29 [0] PB_29_
    ...
    13 [1] PB_13_TP16 input 
    12 [0] PB_12_LCD_CS output 

    11 [0] PB_11_LCD_BL output 
    10 [0] *PB_10_VSLIDE_CH2_Y output 
    09 [0] *PB_09_VSLIDE_CH2_X output 
    08 [0] *PB_08_VSLIDE_CH1_Y output 

    07 [0] *PB_07_VSLIDE_CH1_X output 
    06 [0] *PB_06_VSLIDE_CH0_Y output 
    05 [0] *PB_05_VSLIDE_CH0_X output 
    04 [1] PB_04_BLADE_AN1 input

    03 [1] PB_03_BLADE_AN0 input
    02 [1] PB_02_ACCEL_INT2 input
    01 [1] PB_01_ACCEL_INT1 input
...
/* 
    ...
    29 [0] PA_29_ACCEL_PWR_EN no glitch filter
    ...
    08 [0] PA_08_TP52 no glitch filter

    07 [0] PA_07_TP51 no glitch filter
    06 [0] PA_06_TP49 no glitch filter
...
/*
    ...
    13 [0] PB_13_TP16 no glitch filter
    12 [0] PB_12_LCD_CS no glitch filter

    11 [0] PB_11_LCD_BL no glitch filter
    10 [0] PB_10_VSLIDE_CH2_Y no glitch filter
    09 [0] PB_09_VSLIDE_CH2_X no glitch filter
    08 [0] PB_08_VSLIDE_CH1_Y no glitch filter

    07 [0] PB_07_VSLIDE_CH1_X no glitch filter
    06 [0] PB_06_VSLIDE_CH0_Y no glitch filter
    05 [0] PB_05_VSLIDE_CH0_X no glitch filter
    04 [0] PB_04_BLADE_AN1 no glitch filter

    03 [0] PB_03_BLADE_AN0 no glitch filter
    02 [0] PB_02_ACCEL_INT2 no glitch filter
    01 [0] PB_01_ACCEL_INT1 no glitch filter
...
/* 
    ...
    29 [0] *PA_29_ACCEL_PWR_EN no input filter
    28 [0] PA_28_BUZZER no input filter

    27 [0] PA_27_CLOCK_OUT no input filter
    26 [0] PA_26_TP30 no input filter
    ...
    08 [0] PA_08_TP52 no input filter

    07 [0] PA_07_TP51 no input filter
    06 [0] PA_06_TP49 no input filter
...
/*
    ...
    13 [0] PB_13_TP16 no input filter
    12 [0] PB_12_LCD_CS no input filter

    11 [0] PB_11_LCD_BL no input filter
    10 [0] PB_10_VSLIDE_CH2_Y no input filter
    09 [0] PB_09_VSLIDE_CH2_X no input filter
    08 [0] PB_08_VSLIDE_CH1_Y no input filter

    07 [0] PB_07_VSLIDE_CH1_X no input filter
    06 [0] PB_06_VSLIDE_CH0_Y no input filter
    05 [0] PB_05_VSLIDE_CH0_X no input filter
    04 [0] PB_04_BLADE_AN1 no input filter

    03 [0] PB_03_BLADE_AN0 no input filter
    02 [0] PB_02_ACCEL_INT2 no input filter
    01 [0] PB_01_ACCEL_INT1 no input filter
...
/* 
    ...
    30 [0] PA_30_TP44 N/A
    29 [0] PA_29_ACCEL_PWR_EN output low
...
#define PIOB_SODR_INIT (u32)0x01BFBE00
/*
    31 [0] PB_31_
    30 [0] PB_30_
    29 [0] PB_29_
    ...
    11 [1] PB_11_LCD_BL output high
    10 [1] *PB_10_VSLIDE_CH2_Y output high
    09 [1] *PB_09_VSLIDE_CH2_X output high
    08 [0] *PB_08_VSLIDE_CH1_Y N/A

    07 [0] *PB_07_VSLIDE_CH1_X N/A
    06 [0] *PB_06_VSLIDE_CH0_Y N/A
    05 [0] *PB_05_VSLIDE_CH0_X N/A
    04 [0] PB_04_BLADE_AN1 N/A

    03 [0] PB_03_BLADE_AN0 N/A
    02 [0] PB_02_ACCEL_INT2 N/A
    01 [0] PB_01_ACCEL_INT1 N/A
...
/* 
    ...
    30 [0] PA_30_TP44 N/A
    29 [1] *PA_29_ACCEL_PWR_EN output low
...
/*
    ...
    13 [0] PB_13_TP16 output high
    12 [0] PB_12_LCD_CS output high

    11 [0] PB_11_LCD_BL output high
    10 [0] *PB_10_VSLIDE_CH2_Y output high
    09 [0] *PB_09_VSLIDE_CH2_X output high
    08 [0] *PB_08_VSLIDE_CH1_Y N/A
...
/*
    ...
    11 [0] PB_11_LCD_BL
    10 [0] PB_10_VSLIDE_CH2_Y
    09 [0] PB_09_VSLIDE_CH2_X
    08 [0] PB_08_VSLIDE_CH1_Y

    07 [0] PB_07_VSLIDE_CH1_X
    06 [0] PB_06_VSLIDE_CH0_Y
    05 [0] PB_05_VSLIDE_CH0_X
    04 [0] PB_04_BLADE_AN1

    03 [0] PB_03_BLADE_AN0
    02 [0] PB_02_ACCEL_INT2
    01 [0] PB_01_ACCEL_INT1
    00 [0] PB_00_BUTTON1
*/
...
/* 
    ...
    29 [1] PA_29_ACCEL_PWR_EN not open drain
    28 [1] PA_28_BUZZER not open drain

    27 [1] PA_27_CLOCK_OUT not open drain
    26 [1] PA_26_TP30 not open drain
    ...
    10 [0] PA_10_I2C_SCL
    09 [0] PA_09_I2C_SDA
    08 [1] PA_08_TP52 not open drain

    07 [1] PA_07_TP51 not open drain
    06 [1] PA_06_TP49 not open drain
...
/*
    ...
    13 [1] PB_13_TP16 not open drain
    12 [1] PB_12_LCD_CS not open drain

    11 [1] PB_11_LCD_BL not open drain
    10 [1] PB_10_VSLIDE_CH2_Y not open drain
    09 [1] PB_09_VSLIDE_CH2_X not open drain
    08 [1] PB_08_VSLIDE_CH1_Y not open drain

    07 [1] PB_07_VSLIDE_CH1_X not open drain
    06 [1] PB_06_VSLIDE_CH0_Y not open drain
    05 [1] PB_05_VSLIDE_CH0_X not open drain
    04 [1] PB_04_BLADE_AN1 not open drain

    03 [1] PB_03_BLADE_AN0 not open drain
    02 [1] PB_02_ACCEL_INT2 not open drain
    01 [1] PB_01_ACCEL_INT1 not open drain
...
/* 
    ...
    29 [1] PA_29_ACCEL_PWR_EN no pull-up
    28 [1] PA_28_BUZZER no pull-up

    27 [1] PA_27_CLOCK_OUT no pull-up
    26 [1] PA_26_TP30 no pull-up
    ...
    08 [1] PA_08_TP52 no pull-up

    07 [1] PA_07_TP51 no pull-up
    06 [1] PA_06_TP49 no pull-up
...
/*
    ...
    13 [1] PB_13_TP16 no pull-up
    12 [1] PB_12_LCD_CS no pull-up

    11 [1] PB_11_LCD_BL no pull-up
    10 [1] PB_10_VSLIDE_CH2_Y no pull-up
    09 [1] PB_09_VSLIDE_CH2_X no pull-up
    08 [1] PB_08_VSLIDE_CH1_Y no pull-up 

    07 [1] *PB_07_VSLIDE_CH1_X no pull-up
    06 [1] *PB_06_VSLIDE_CH0_Y no pull-up
    05 [1] *PB_05_VSLIDE_CH0_X no pull-up
    04 [1] PB_04_BLADE_AN1 no pull-up

    03 [1] PB_03_BLADE_AN0 no pull-up
    02 [1] *PB_02_ACCEL_INT2 no pull-up
    01 [1] *PB_01_ACCEL_INT1 no pull-up
...
/*
    ...
    29 [0] PA_29_ACCEL_PWR_EN no pull-up
    28 [0] PA_28_BUZZER no pull-up

    27 [0] PA_27_CLOCK_OUT no pull-up
    26 [0] PA_26_TP30 no pull-up
    ...
    08 [0] *PA_08_TP52 no pull-up

    07 [0] PA_07_TP51 no pull-up
    06 [0] PA_06_TP49 no pull-up
...
/*
    ...
    13 [0] PB_13_TP16 no pull-up
    12 [0] PB_12_LCD_CS no pull-up

    11 [0] PB_11_LCD_BL no pull-up
    10 [0] PB_10_VSLIDE_CH2_Y no pull-up
    09 [0] PB_09_VSLIDE_CH2_X no pull-up
    08 [0] PB_08_VSLIDE_CH1_Y no pull-up 

    07 [0] PB_07_VSLIDE_CH1_X no pull-up
    06 [0] PB_06_VSLIDE_CH0_Y no pull-up
    05 [0] PB_05_VSLIDE_CH0_X no pull-up
    04 [0] PB_04_BLADE_AN1 no pull-up

    03 [0] PB_03_BLADE_AN0 no pull-up
    02 [0] PB_02_ACCEL_INT2 no pull-up
    01 [0] PB_01_ACCEL_INT1 no pull-up
...
/* 
    ...
    07 [0] PA_07_TP51 N/A
    06 [0] PA_06_TP49 N/A
    05 [0] *PA_05_HSLIDE_CH2_Y PERIPHERAL A
    04 [0] *PA_04_HSLIDE_CH2_X PERIPHERAL A

    03 [0] *PA_03_HSLIDE_CH1_Y PERIPHERAL A
    02 [0] *PA_02_HSLIDE_CH1_X N/A
    01 [0] *PA_01_HSLIDE_CH0_Y N/A
    00 [0] *PA_00_HSLIDE_CH0_X N/A
*/
...
/*
    ...
    11 [0] PB_11_LCD_BL N/A
    10 [0] *PB_10_VSLIDE_CH2_Y N/A
    09 [0] *PB_09_VSLIDE_CH2_X N/A
    08 [0] *PB_08_VSLIDE_CH1_Y N/A
...
*/
#define PIOA_OWER_INIT (u32)0xB401004F
/* 
    31 [1] PA_31_HEARTBEAT write enabled
    30 [0] PA_30_TP44
    29 [1] PA_29_ACCEL_PWR_EN write enabled
...
/*
    ...
    11 [1] PB_11_LCD_BL write enabled
    10 [1] PB_10_VSLIDE_CH2_Y write enabled
    09 [1] PB_09_VSLIDE_CH2_X write enabled
    08 [1] PB_08_VSLIDE_CH1_Y write enabled

    07 [1] PB_07_VSLIDE_CH1_X write enabled
    06 [1] PB_06_VSLIDE_CH0_Y write enabled
    05 [1] PB_05_VSLIDE_CH0_X write enabled
    04 [0] PB_04_BLADE_AN1
